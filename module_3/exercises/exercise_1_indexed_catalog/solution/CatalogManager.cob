      ...
      *>======================================================*
      *> EXERCISE 1 (SOLUTION): Indexed Product Catalog       *
      *> Demonstrates complete CRUD operations and sequential  *
      *> traversal over an ISAM indexed file in GnuCOBOL.     *
      *>======================================================*
       ...
       0000-MAIN.
           ...
           DISPLAY "=================================================="
           DISPLAY "Exercise 1 completed successfully."
