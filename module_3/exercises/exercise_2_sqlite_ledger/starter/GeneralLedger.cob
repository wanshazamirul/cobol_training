      ...
      *>======================================================*
      *> EXERCISE 2 (STARTER): SQLite Financial Ledger        *
      *>                                                      *
      *> Instructions:                                        *
      *> 1. Open SQLite database 'ledger.db'                  *
      *> 2. Create the 'journal' table                        *
      *> 3. Use ACID transactions (BEGIN TRANSACTION, COMMIT) *
      *> 4. Query entries using cursor step logic             *
      *> 5. Calculate account balances                        *
      *> 6. Test overdraft protection using ROLLBACK          *
      *>======================================================*
      ...
      *> TODO 1: Call cob_sqlite_open for 'ledger.db'
      ...
      *> TODO 2: Create table journal (entry_id INT, account TEXT, tx_type TEXT, amount REAL)
      ...
      *> TODO 3: Begin transaction, insert 3 entries, and commit
      ...
      *> TODO 4: Prepare query and step through results
      ...
      *> TODO 5: Test withdrawing $1000.00 from Checking
